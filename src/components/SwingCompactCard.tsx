...
export function SwingCompactCard({ recommendation }: SwingCompactCardProps) {
  ...
  // Potential profit % (to max target from recommended price)
  const potentialProfit = ((target2 - recommendedPrice) / recommendedPrice) * 100;
  // Potential risk % (stoploss from recommended price)
  const potentialRisk = Math.abs(((stoploss - recommendedPrice) / recommendedPrice) * 100);
        ...
        <div className="p-4 flex items-center justify-between gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="px-1.5 py-0.5 rounded text-[10px] font-medium bg-blue-500/20 text-blue-400 shrink-0">
                SWING
              </span>
